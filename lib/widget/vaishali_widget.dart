...
import 'package:lstrv_app/destinations/vaishali/vaishali_details_page.dart';
...
class Vaishali_PlaceWidget extends StatelessWidget {
  final Vaishali_Place place;
  final bool compactMode;

  Vaishali_PlaceWidget({this.place, this.compactMode = false});
